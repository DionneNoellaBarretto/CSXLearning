/*
Exercise Link: https://csx.codesmith.io/units/precourse/challenge-data-types-basics 
Take a stab at declaring some variables below with different data types. Make sure to read the challenge carefully so you know if you should be using let or const!
